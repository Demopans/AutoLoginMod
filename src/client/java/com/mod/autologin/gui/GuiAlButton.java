...
public class GuiAlButton extends GuiButton {
	...
	public static final TextAnimation TA_SWITCH_AQUA = buildSwitch(TextFormatting.DARK_AQUA, TextFormatting.AQUA);
	public static final TextAnimation TA_SWITCH_YELLOW = buildSwitch(TextFormatting.GOLD, TextFormatting.YELLOW);
	public static final TextAnimation TA_SWITCH_GREEN = buildSwitch(TextFormatting.DARK_GREEN, TextFormatting.GREEN);
	public static final TextAnimation TA_SWITCH_ALL_HEAVY = buildSwitch(TextFormatting.DARK_AQUA,
			TextFormatting.DARK_GREEN, TextFormatting.DARK_RED, TextFormatting.DARK_PURPLE, TextFormatting.GOLD);
	public static final TextAnimation TA_SWITCH_ALL_LIGHT = buildSwitch(TextFormatting.AQUA, TextFormatting.GREEN,
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks) {
		if (this.visible) {
			...
			int x = this.x;
			int y = (int) (this.y + height / 2 - fontrenderer.FONT_HEIGHT * sizeFactor / (2));
			...
			drawGradientRect(this.x, this.y, this.x + width, this.y + height, c, c);
