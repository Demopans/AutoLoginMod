...
public class GuiAutoLogin extends GuiAl {
	...
	private static class BiDialogBox extends GuiAl {
		...
		public void drawScreen(int mouseX, int mouseY, float partialTicks) {
			...
			GuiPasswordBox.drawCenterString(fontRenderer, s, width / 2, height / 2 - 24, fontRenderer.FONT_HEIGHT,
					0xffffffff);
			int sizeX = Math.max(fontRenderer.getStringWidth(s), 306) / 2 + 8;
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		GuiAlButton.drawScaledCenterString(fontRenderer, ModMain.MOD_NAME, width / 2, height / 2 - 60, 0xffeb00bd,
				3.0F);
		super.drawScreen(mouseX, mouseY, partialTicks);
	}
